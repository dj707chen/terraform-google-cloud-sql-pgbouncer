...
// The subnetwork to be used by Cloud PG in the underlying Google service producer's VPC network
data "google_compute_subnetwork" "producer-subnet" {
  project = var.project
...
module "db" {
  ...
  ip_configuration = {
    ...
    // "google-managed-services-${var.subnetwork_name}"
